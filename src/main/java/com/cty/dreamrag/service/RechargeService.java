...
import com.cty.dreamrag.model.RechargeOrder;
import com.cty.dreamrag.model.RechargeOrder.OrderStatus;
import com.cty.dreamrag.model.RechargePackage;
import com.cty.dreamrag.repository.RechargeOrderRepository;
import com.cty.dreamrag.repository.RechargePackageRepository;
import com.cty.dreamrag.utils.PriceUtil;
...
public class RechargeService {
    ...
    public WxPayService.PrePayInfoResBo createRechargeOrder(
        ...
        if (packageId != null && packageId > 0) {
            ...
            description = "【Dream RAG】充值套餐：" + rechargePackage.getPackageName();
        } else {
            // 自定义充值
            ...
            description = "【Dream RAG】自定义充值￥" + PriceUtil.toYuanPrice(amount) + "元";
        }
