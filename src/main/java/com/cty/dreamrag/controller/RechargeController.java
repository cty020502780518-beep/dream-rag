...
import com.cty.dreamrag.service.RechargeService;
import com.cty.dreamrag.service.WxPayService;
...
public class RechargeController {
    ...
    public ResponseEntity<?> getPackages() {
        try {
            List<com.cty.dreamrag.model.RechargePackage> packages = rechargeService.getAllPackages();
